...
// 白背景時の初期フォールバックパレット (color-memo スタイル)
export function fallbackPalette() {
  return [
    { r: 40, g: 50, b: 56, hex: "#283238" },
    { r: 76, g: 91, b: 100, hex: "#4C5B64" },
    { r: 130, g: 147, b: 156, hex: "#82939C" },
    { r: 180, g: 195, b: 204, hex: "#B4C3CC" },
    { r: 226, g: 234, b: 238, hex: "#E2EAEF" }
  ];
}
